...
class QuizPanel(QWidget):
    ...
    def _build_intro_page(self) -> QWidget:
        ...
        title = QLabel("Session Quiz")
        title.setAlignment(Qt.AlignmentFlag.AlignCenter)
        title.setStyleSheet("font-size: 20px; font-weight: 700;")
        layout.addWidget(title)

        subtitle = QLabel("Test yourself on the material covered in this session.")
        ...
        message_card = QFrame()
        message_card.setObjectName("quizIntroCard")
        message_card.setFrameShape(QFrame.Shape.NoFrame)
        message_card.setAttribute(Qt.WidgetAttribute.WA_StyledBackground, True)
        ...
        msg_font = self.intro_message.font()
        msg_font.setPointSize(11)
        self.intro_message.setFont(msg_font)
        card_layout.addWidget(self.intro_message)
        ...
        self.retake_button.setToolTip("Answer the existing quiz again from the start.")
        ...
        self.generate_button.setToolTip("Create a new quiz from this session with Gemini.\n"
                                        "Replaces any existing quiz. Needs a Gemini API key.")
    ...
    def _show_question(self, idx: int) -> None:
        ...
        for i, opt in enumerate(q.get("options", [])):
            ...
            radio.setToolTip("Select this as your answer.")
