...
class SettingsPanel(QWidget):
    ...
    def __init__(self, sessions, base_dir, bundled_sounds_dir, icons_dir, themes_dir) -> None:
        ...
        processing_note = QLabel("All processing uses the Google Gemini API. "
                                 "Slide OCR, audio transcription, and summarisation are all online. "
                                 "Tesseract is used locally only to detect duplicate slides before sending to Gemini.")
        ...
        self.api_use_speech.setToolTip("Use Gemini for speech-to-text.")
        self.api_use_summarize = QCheckBox("Summary")
        self.api_use_summarize.setToolTip("Use Gemini to write the session summary.")
        ...
        self.api_layout.addWidget(self.api_engines_container, 2, 0, 1, 2)
        ...
        self.api_layout.addWidget(self.test_api_button, 3, 0, 1, 2)
        ...
        self.api_layout.addWidget(self.api_test_output, 4, 0, 1, 2)
        ...
        self.api_layout.addWidget(self.api_test_note, 5, 0, 1, 2)
    ...
    def update_ui(self) -> None:
        self.api_engines_container.setVisible(True)
    ...
    def _on_save(self) -> None:
        ...
        self.settings.sync()
        self.settings.setValue("processing_mode", "api")
        self.api_keys_changed.emit(gemini_key)
        self.processing_mode_changed.emit("api")
